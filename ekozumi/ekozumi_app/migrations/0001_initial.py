    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minLatitude', models.IntegerField()),
                ('maxLatitude', models.IntegerField()),
                ('minLongitude', models.IntegerField()),
                ('maxLongitude', models.IntegerField()),
        ...
        migrations.CreateModel(
            name='Monster',
            fields=[
                ('mosterID', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastFed', models.DateTimeField(default=datetime.datetime(2023, 3, 9, 14, 5, 37, 972511, tzinfo=datetime.timezone.utc))),
                ('petType', models.CharField(choices=[('Hedgehog', 'Hedgehog'), ('Badger', 'Badger'), ('Frog', 'Frog'), ('Bat', 'Bat'), ('Weasel', 'Weasel'), ('Rabbit', 'Rabbit')], max_length=9)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
